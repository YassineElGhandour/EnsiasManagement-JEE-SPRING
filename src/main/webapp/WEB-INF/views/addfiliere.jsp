                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header" data-background-color="blue">
                                    <h4 class="title">Ajouter une nouvelle fillière</h4>
                                </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group label-floating">
                                                    <label class="control-label">Nom de la fillière</label>
                                                    <input class="form-control" name="nomFiliere" type="text" autofocus="" required>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group label-floating">
                                                    <label class="control-label">Nombre de Classes</label>
                                                    <input class="form-control" name="nombreClasse" type="text" autofocus="" required>                             
                                                </div>
                                            </div>
                                        </div>
