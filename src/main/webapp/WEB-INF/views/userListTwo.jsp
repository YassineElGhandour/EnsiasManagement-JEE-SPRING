...
<html>
    ...
    <title>Consulter l'emploi par filière</title>
        ...
        <div class="main-panel">
            ...
            <div class="content">
                <div class="container-fluid">
                                	...
                                	<div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group label-floating">
                                                    ...
                                                    <select name="DropBoxFilieres" class ="form-control">
                                           	...
                                           	<div class="col-md-12">
                                                <div class="form-group label-floating">
                                                    ...
                                                    <select name="DropBoxSemaine" class ="form-control">
                                                            ...
                                                            <option value="Semaine 8">Semaine 9</option>
					...
					<button type="submit" class="btn btn-info pull-right">Télécharger l'emploi</button>
