                        ...
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-content">
                                    <form action="/insertemploi" method="POST">
										<div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group label-floating">
                                                    <label class="control-label">Heure</label>
                                                    <select name="heureEmploi" class ="form-control">
										...
										<div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group label-floating">
                                                    ...
                                                    <select name="jourEmploi" class ="form-control">
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group label-floating">
                                                    <label class="control-label">Nom de la filière</label>
                                                    	<select name="DropBoxFiliere" class ="form-control">
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group label-floating">
                                                    <label class="control-label">Semaine</label>
                                                     	<select name="semaineEmploi" class ="form-control">
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group label-floating">
                                                    <label class="control-label">Nom de la matière</label>
                                                    	<select name="DropBoxMatiere" class ="form-control">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group label-floating">
                                                    <label class="control-label">Nom du professeur</label>
                                                    	<select name="DropBoxProf" class ="form-control">
                                                        <c:forEach items="${professeurs}" var="professeur">
                                                            <option value="${professeur.email}">${professeur.nomProfesseur} ${professeur.prenomProfesseur}</option>
                                                        </c:forEach>
                                                    </select> 
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group label-floating">
                                                    <label class="control-label">Date Début </label>
                                               	    <input class="form-control" name="dateDebutEmploi" type="date" autofocus="" required>
                                                </div>
                                            </div>
                                        </div>      
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group label-floating">
                                                    <label class="control-label">Date Fin</label>
                                               	    <input class="form-control" name="dateFinEmploi" type="date" autofocus="" required>
                                                </div>
                                            </div>
                                        </div> 
