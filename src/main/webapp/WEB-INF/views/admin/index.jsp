            ...
            <div class="navbar-header">
                <div class="top-left-part">
                    ...
                    <a class="logo" href="index.html">
                        ...
                        <!--This is dark logo icon--><img src="/resources/plugins/images/admin-logo.png" alt="home" class="dark-logo" /><!--This is light logo icon--><img src="/resources/plugins/images/admin-logo-dark.png" alt="home" class="light-logo" />
                     </b>
                        <!-- Logo text image you can use text also --><span class="hidden-xs">
                        <!--This is dark logo text--><img src="/resources/plugins/images/admin-text.png" alt="home" class="dark-logo" /><!--This is light logo text--><img src="/resources/plugins/images/admin-text-dark.png" alt="home" class="light-logo" />
                     </span> </a>
                </div>
                <!-- /Logo -->
                <ul class="nav navbar-top-links navbar-right pull-right">
                    ...
                    <li>
                        <a class="profile-pic" href="/admin/login?logout"> <img src="/resources/plugins/images/users/varun.jpg" alt="user-img" width="36" class="img-circle"><b class="hidden-xs">Steave</b></a>
                    </li>
                </ul>
            </div>
            <!-- /.navbar-header -->
                        ...
                        <div class="white-box">
                            ...
                            <div class="comment-center p-t-10">
                                <div class="comment-body">
                                    <div class="user-img"> <img src="/resources/plugins/images/users/pawandeep.jpg" alt="user" class="img-circle">
                                    </div>
                                ...
                                <div class="comment-body">
                                    <div class="user-img"> <img src="/resources/plugins/images/users/sonu.jpg" alt="user" class="img-circle">
                                    </div>
                                    <div class="mail-contnet">
                                ...
                                <div class="comment-body b-none">
                                    <div class="user-img"> <img src="/resources/plugins/images/users/arijit.jpg" alt="user" class="img-circle">
                                    </div>
                                    <div class="mail-contnet">
