                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header" data-background-color="blue">
                                    <h4 class="title">Ajouter un nouvelle salle</h4>
                                </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group label-floating">
                                                    ...
                                                    <input class="form-control" name="nomSalle" type="text" autofocus="" required>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group label-floating">
                                                    ...
                                                    <select name="heureSalle" class ="form-control">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group label-floating">
                                                    ...
                                                    <input class="form-control" name="dateSalle" type="date" autofocus="" required>                                                                        
                                                </div>
                                            </div>
                                        </div>
                                        -->
